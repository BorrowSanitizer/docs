...
![Average execution time for Miri (2.08 sec), BorrowSanitizer (1.26 sec), AddressSanitizer (0.005 sec), ThreadSanitizer (0.01 sec) and both debug (0.0006 sec) and release (0.0004 sec) builds for `test_lots_of_insertions`.](images/february_2026_all.png =500x center)
